...
def register_event_handlers(event_handlers, orthanc_module):
    ...
    class Event:
        ...
        def __str__(self):
            return f"Event(change_type={event_types.get(self.change_type)}, resource_type={self.resource_type}, resource_id='{self.resource_id}')"
    ...
    def OnChange(change_type, resource_type, resource_id):
        ...
        for handler in handlers:
            event = Event(change_type, resource_type, resource_id)
